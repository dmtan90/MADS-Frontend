  ...
  <div class="settings-container">
      <div class="settings-left-box">
        <div class="add-entity-box">
            <b-button class="add-entity-button" @click="addEntity()">+  Add business Entities</b-button>
        </div>
        <template v-if="entities.length > 0">
            <div class="entities-box" v-for="(entity, index) in entities" :key="index">
                <div class="entity-box" @click="showCriteriaForm(entity, index)" v-bind:class="{active: index === selectedEntityIndex}">
                    <div class="entity-name-text">
                        {{entity.name}}
                    </div>
                    <div class="more-icon-dropdown">
                        <b-button class="more-icon" @click="showDelete(index)"><img src="../../../../assets/img/icons/more.svg" /></b-button>
...
export default {
  ...
  methods: {
    addEntity () {
      this.entities = this.$_.concat(this.entities, [{ id: '', name: '', desc: '', hide: false, entityType: '', type: '' }])
      this.selectedEntity = { id: '', name: '', desc: '', hide: false, entityType: '', type: '' }
    },
    showDelete (id) {
      this.isDelete = true
      this.entityId = id
