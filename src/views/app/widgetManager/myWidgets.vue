  ...
  <div class="widget-store">
    <div v-if="showWidgetStore">
      ...
      <div class="widgets-section">
        <div class="widgets">
          <b-row>
            <b-colxx lg="4" md="4" sm="6" xs="12" xxs="12" class="widget" v-for="(user_widget, index) in userWidgets" :key="index">
              <div class="widget-container">
                <div class="widget-image">
                  <img :src="user_widget.widget.image_url" alt="" @click="openWidgetDetailPage(user_widget.widget)">
                </div>
                <div class="widget-info">
                  <h3>{{user_widget.widget.label}}</h3>
                </div>
              </div>
            </b-colxx>
          </b-row>
    ...
    <widget-detail v-if="showWidgetDetail" :userWidget="true"></widget-detail>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapGetters(['currentUser', 'openedWidgetDetail', 'showWidgetStore', 'showWidgetDetail'])
  },
  mounted() {
