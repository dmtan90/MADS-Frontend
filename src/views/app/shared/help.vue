  ...
  <div class="help-container">
    <header class="cd-header flex flex-column flex-center">
      <div class="text-component text-center">
        <h1>{{appName}} - Help</h1>
        <p><a class="cd-article-link" href="https://datakrew.com/contact" target="_blank">For further information or troubleshooting, contact us 🙏</a></p>
      </div>
    </header>

    <section class="cd-faq js-cd-faq container max-width-md margin-top-lg margin-bottom-lg">
      <ul class="cd-faq__categories">
        <li @click="selectTab('basics')" :class="{selected: selectedTab === 'basics'}"><a class="cd-faq__category">Basics</a></li>
        <li @click="selectTab('mobile')" :class="{selected: selectedTab === 'mobile'}"><a class="cd-faq__category">Mobile</a></li>
        <li @click="selectTab('account')" :class="{selected: selectedTab === 'account'}"><a class="cd-faq__category">Account</a></li>
        <li @click="selectTab('payments')" :class="{selected: selectedTab === 'payments'}"><a class="cd-faq__category">Payments</a></li>
        <li @click="selectTab('privacy')" :class="{selected: selectedTab === 'privacy'}"><a class="cd-faq__category">Privacy</a></li>
        <li @click="selectTab('delivery')" :class="{selected: selectedTab === 'delivery'}"><a class="cd-faq__category">Delivery</a></li>
      </ul> <!-- cd-faq__categories -->

      <div class="cd-faq__items">
        <ul id="basics" class="cd-faq__group" v-if="selectedTab === 'basics'">
          <li class="cd-faq__title"><h2>Basics</h2></li>
          <div role="tablist">
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-1>
                <div block variant="info" class="header-text">How do I change my password?</div>
                <svg class="icon">
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-2>
                <div block variant="info" class="header-text">How do I sign up?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-3>
                <div block variant="info" class="header-text">Can I remove a post?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-4>
                <div block variant="info" class="header-text">How do reviews work?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
        ...
        <ul id="mobile" class="cd-faq__group" v-if="selectedTab === 'mobile'">
          <li class="cd-faq__title"><h2>Mobile</h2></li>
          <div role="tablist">
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-1>
                <div block variant="info" class="header-text">How does syncing work?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-2>
                <div block variant="info" class="header-text">How do I upload files from my phone or tablet?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-3>
                <div block variant="info" class="header-text">How do I link to a file or folder?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
        ...
        <ul id="account" class="cd-faq__group" v-if="selectedTab === 'account'">
          ...
          <div role="tablist">
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-2>
                <div block variant="info" class="header-text">How do I delete my account?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-3>
                <div block variant="info" class="header-text">How do I change my account settings?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-4>
                <div block variant="info" class="header-text">I forgot my password. How do I reset it?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
        ...
        <ul id="payments" class="cd-faq__group" v-if="selectedTab === 'payments'">
          <li class="cd-faq__title"><h2>Payments</h2></li>
          <div role="tablist">
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-2>
                <div block variant="info" class="header-text">Can I have an invoice for my subscription?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-3>
                <div block variant="info" class="header-text">Why did my credit card or PayPal payment fail?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-4>
                <div block variant="info" class="header-text">Why does my bank statement show multiple charges for one upgrade?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
        ...
        <ul id="privacy" class="cd-faq__group" v-if="selectedTab === 'privacy'">
          <li class="cd-faq__title"><h2>Privacy</h2></li>
          <div role="tablist">
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-1>
                <div block variant="info" class="header-text">Can I specify my own private key?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-2>
                <div block variant="info" class="header-text">My files are missing! How do I get them back?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-3>
                <div block variant="info" class="header-text">How can I access my account data?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-4>
                <div block variant="info" class="header-text">How can I control if other search engines can link to my profile?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
        ...
        <ul id="delivery" class="cd-faq__group" v-if="selectedTab === 'delivery'">
          <li class="cd-faq__title"><h2>Delivery</h2></li>
          <div role="tablist">
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-1>
                <div block variant="info" class="header-text">What should I do if my order hasn't been delivered yet?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-2>
                <div block variant="info" class="header-text">How can I find your international delivery information?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-3>
                <div block variant="info" class="header-text">Who takes care of shipping?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-4>
                <div block variant="info" class="header-text">How do returns or refunds work?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-5>
                <div block variant="info" class="header-text">How do I use shipping profiles?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-6>
                <div block variant="info" class="header-text">How does your UK Next Day Delivery service work?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-7>
                <div block variant="info" class="header-text">How does your Next Day Delivery service work?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-8>
                <div block variant="info" class="header-text">When will my order arrive?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
            ...
            <b-card no-body class="mb-1">
              <b-card-header header-tag="header" class="p-1" role="tab" v-b-toggle.accordion-9>
                <div block variant="info" class="header-text">When will my order ship?</div>
                <svg class="icon">
                  <use xlink:href="/assets/img/mads-common-icons.svg#arrow-down"></use>
                </svg>
              </b-card-header>
