...
export default {
    ...
    initDemo(json, nodeTarget, w, h) {
      ...
      function update(source) {
        ...
        nodeEnter
          ...
          .style(
            "font",
            "14px Consolas, Lucida Console, Menlo, Monaco, monospace"
          )
          .style("fill", "#333")
          .style("pointer-events", "none")
          .text(function(d) {
      ...
      function drawTree(json) {
        tree = d3.layout.tree().size([h, 100])
        ...
        diagonal = function(d) {
          ...
          var points = [
            "M",
            [d.source.y + deltaX, d.source.x + deltaY].join(","),
            "L",
            [d.source.y + deltaX, d.target.x + deltaY].join(","),
            "L",
            [d.target.y + deltaX, d.target.x + deltaY].join(",")
          ]
          return points.join("")
        }
  ...
  mounted() {
    ...
    // this.initDemo(node1, 'div.domtree', 690, 320);
  }
}
</script>
