<template>
  <div class="data-history-container">
    ...
    <div v-if="selectedTab === 'water_inlet'">
      ...
      <div v-if="selectedSubTab === 'data_history'" class="data-history">
        <highcharts :options="pHChartOptions" class="chart-item">
        </highcharts>
        <highcharts :options="conductivityChartOptions" class="chart-item">
        </highcharts>
        <highcharts :options="orpChartOptions" class="chart-item">
        </highcharts>
        <highcharts :options="turbidityChartOptions" class="chart-item">
        </highcharts>
        <highcharts :options="tempChartOptions" class="chart-item">
        </highcharts>
      </div>
    </div>
