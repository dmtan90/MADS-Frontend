<template>
  <div class="occupancy-container">
    <div class="room-utilization-chart">
      <highcharts :options="roomUtilizationOptions" class="widget">
      </highcharts>
    </div>
    <div class="indoor-air-quality-params">
      <h2>Indoor Air Quality Parameters</h2>
      <div class="first-row">
        <highcharts :options="tempChartOptions" class="chart-item">
        </highcharts>
        <highcharts :options="humidityChartOptions" class="chart-item">
        </highcharts>
        <highcharts :options="pressureChartOptions" class="chart-item">
        </highcharts>
      </div>
      <div class="second-row">
        <highcharts :options="pm25ChartOptions" class="chart-item">
        </highcharts>
        <highcharts :options="pm100ChartOptions" class="chart-item">
        </highcharts>
        <highcharts :options="eco2ChartOptions" class="chart-item">
        </highcharts>
      </div>
    </div>
  </div>
...
export default {
  ...
  mounted () {
    this.roomUtilizationOptions = {
      chart: {
        type: 'column'
      },
      title: {
        text: 'Room Utilization by day',
        align: 'left',
        margin: 40
      },
      xAxis: {
