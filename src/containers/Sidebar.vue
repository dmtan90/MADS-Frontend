    ...
    <div class="main-menu">
      ...
      >
        <ul class="list-unstyled">
          ...
          <li
            :class="{ active: selectedParentMenu === 'device-configuration' }"
          >
            <a
              @click.prevent="openSubMenu($event, 'device-configuration')"
          ...
          <li :class="{ active: selectedParentMenu === 'single' }">
            <router-link
              :class="{ active: selectedParentMenu === 'single' }"
              @click.native="changeSelectedParentHasNoSubmenu('pages')"
              to="/app/tool-management"
              tag="li"
            >
              <a><i class="simple-icon-wrench"></i> Tool<br>Management </a>
            </router-link>
          </li>
        </ul>
      </vue-perfect-scrollbar>
